...
test("routes profitability and non-media-cost insights to the exact business month", () => {
  assert.deepEqual(
    ...
    {
      href: "/businesses/business%20fixture%2F01/monthly?month=2026-09",
...
test("routes lifetime-economics insights to the exact customer profitability month", () => {
  assert.deepEqual(
    ...
    {
      href: "/businesses/business%20fixture%2F01/customers?view=profitability&month=2026-09",
...
test("routes attendance insights to the exact funnel card for the selected month", () => {
  assert.deepEqual(
    ...
    {
      href: "/businesses/business%20fixture%2F01/funnels/monthly?month=2026-09#funnel-funnel%2Fa",
