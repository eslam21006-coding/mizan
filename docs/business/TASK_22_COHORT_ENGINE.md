...
10. Task 23 Observed LTV remains a separate calculation layer implemented only after this Task 22 cohort base is established in the approved combined pair.
